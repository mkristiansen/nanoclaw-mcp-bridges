#!/usr/bin/env node
// MCP stdio <-> SSE bridge for Atlassian Rovo MCP via mcp-remote on work laptop
// Same curl-subprocess pattern as tolaria-bridge.mjs — avoids undici/fetch proxy issues
// Reconnects automatically when the SSE stream drops
import { spawn } from 'child_process';
import { createInterface } from 'readline';

const SSE_URL = 'http://host.docker.internal:8082/sse';
